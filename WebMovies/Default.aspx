...
<body>
    ...
    <div>
        ...
        <div><label for="DropDownListYears" id="lblYearsDdl" runat="server"></label><asp:DropDownList ID="DropDownListYears" runat="server" AutoPostBack="true"></asp:DropDownList></div>
